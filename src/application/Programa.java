	...
	public static void main(String[] args) {
		...
		while (sair == 1) {
			...
			try {
							...
							if (caixaAberto == 1) {
								do {
									try {
										...
										System.out.println("ERRO! Digite apenas números para retirar o valor \n");
										sairMenu = 2;
										sc.nextLine();
									}
								} while (sairMenu == 1);
				...
				System.out.print("ERRO! Digite apenas números para fazer a seleção \n\n");
				sc.nextLine();
			}
			catch (Exception exception) {
			    System.out.println("Ocorreu um erro inesperado. Detalhes: " + exception.getMessage());
			    sc.nextLine();
			}
		}
		sc.close();
